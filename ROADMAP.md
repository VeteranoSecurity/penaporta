...
- [x] **Verificação de Dispositivo Prioritária & Alerta Restritivo Mobile**: Atualizado o fluxo no [`App.tsx`](file:///c:/Users/jesse/Documents/Trabalho/projetos/penaporta/src/App.tsx) para realizar a verificação do dispositivo **imediatamente na montagem do aplicativo**. Dispositivos móveis exibem o modal [`MobileRestrictionModal.tsx`](file:///c:/Users/jesse/Documents/Trabalho/projetos/penaporta/src/components/MobileRestrictionModal.tsx) sem carregar o vídeo de abertura, enquanto computadores executam a intro e a revelação futurista.
